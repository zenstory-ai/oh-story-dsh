...
每个剧情单元先设计能制造情绪与兑现的**正向发动机**，再按契约四问检查：
...
2. **后用项目读者契约做负向护栏诊断**：按契约四问排查契约/推进失败——主角是否靠自己的选择挣到结果，收益有没有被无交换地拿走，有没有提前动用终局底牌或把升级线顶到天花板，旧期待付了利息没。“安全”只代表没踩红线，不代表好看；护栏不能代替情绪发动机。
