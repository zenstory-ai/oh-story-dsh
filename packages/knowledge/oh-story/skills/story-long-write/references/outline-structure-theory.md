...
与字数预算的衔接：章节定位只改密 / 疏配比的下限，不改 Σ 契约。高压章靠多密点达到 Σ∈[章目标, ×1.1]；低压生活 / 信息整理 / 纯过场章靠铺点（120-150）与疏点（40-60）凑字、允许 0 密点，但关系回收章要保 ≥1 个情感密点（250-320），否则关系写塌。写后字数 <90% 定位欠账时，高压 / 推进章补密点重写，低压 / 过场章补铺垫 / 互动 / 表演 beat，不强塞爽点密点——低密点是设计，不是欠账。
