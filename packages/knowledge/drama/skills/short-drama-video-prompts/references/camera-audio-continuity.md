...
主体快跑与摄影机缓推可以同时成立，关键是写清两者的相对关系与画面结果。
需要跟随时说明跟随方向和构图；需要人物离开画面时，保留缓推或固定机位也可以。
不能为了消除速度差异而改写上游已确定的运镜。

### 运动说明

按本镜需要说明运动方式、方向、速度或触发时机、终点以及要保持的空间关系。
与上一节的起点和落点一起核对，不要求每次恰好四项。
