...
两份 README 在 #46/#47 的骨架上改四处，其余章节保留：
...
- 代价：README 中文 224→400 行左右、英文 239→410 行左右；「看看它的输出」里的行号（分镜.md:21 等）和示例工程内容绑定，下次同步上游 demo 时要重跑探针核对；动图仍然是集成测试画面，右侧 Chat 的测试提示词还在。
